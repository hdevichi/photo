...
<%@page import="org.devichi.photo.control.servlet.AdminAppControl"%>
...
for (int i = 0 ; i < supLocs.length ; i++) {
	formattedSupLocs += supLocs[i]+org.devichi.photo.model.config.PhotoConfigurationConstants.SUPPORTED_LOCALES_SEPARATOR;	
}%>
<HEAD>
