...
<%@page import="org.devichi.photo.control.servlet.AdminUserControl"%>
<HTML>
...
org.devichi.photo.model.user.PhotoUser userToUpdate = (PhotoUser)request.getAttribute(AdminServlet.REQUEST_ATTRIBUTE_USER_TO_ADMIN);%>
